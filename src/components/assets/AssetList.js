...
const [employeeMap, setEmployeeMap] = useState({});
    ...
    try {
        ...
        const [assetsResponse, employeesResponse] = await Promise.all([
            axios.get('https://namami-infotech.com/LIT/src/assets/get_issue_asset.php', { params }),
    ...
    const fetchAvailableAssets = async () => {
        try {
            const response = await axios.get('https://namami-infotech.com/LIT/src/assets/get_asset.php');
    ...
    const handleIssueAssetSubmit = async () => {
        setLoading(true);
        try {
            const response = await axios.post('https://namami-infotech.com/LIT/src/assets/issue_asset.php', {
    ...
    const handleAddNewAsset = async () => {
        try {
            const response = await axios.post('https://namami-infotech.com/LIT/src/assets/add_asset.php', {
    ...
    const handleStatusChangeSubmit = async () => {
        setLoading(true);
        try {
            const response = await axios.post('https://namami-infotech.com/LIT/src/assets/update_asset_status.php', {
        ...
        <div>
            {user.role === 'HR' && (
                <Button
                    ...
                    style={{ backgroundColor: "#CC7A00", color: "white", marginBottom: "20px" }}
                >
                    Issue Asset
                </Button>
            )}
