      ...
      >
        ...
        >
          ...
          >
            ...
            <Button onClick={() => setOpenDialog(true)} style={{ marginTop: 10 }}>
              Forgot Password?
            </Button>
            <Box display="flex" flexDirection="row" justifyContent="center" alignItems="center" mt={3}>
              <Link to="https://play.google.com/store/apps/details?id=com.nanami.hrsmile" target="_blank">
                 <img src={playstore} alt="Google Play Store" width={140} style={{ marginRight: 10, cursor: "pointer" }} />
              </Link>
              <Link to="https://apps.apple.com/in/app/hr-smile/id6738949653" target="_blank">
                 <img src={appstore} alt="Apple App Store" width={130} style={{ cursor: "pointer" }} />
              </Link>
            </Box>
          </Box>
        </Grid>
